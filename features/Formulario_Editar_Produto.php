...
?>
    ...
    <form class="" action="./controllers/ControllerAtualizarProduto.php?id=<?php echo $linha['produto_id']; ?>" onsubmit="return validate()" id="form" name="form" method="post">
        <div class="listagem-grid">
            <div class="grid-items">
                <label for="sku" id="sku">SKU*: </label>
            </div>
            <div class="grid-items" id="sku_div">
                <input type="text" name="txtsku" value="<?php echo $produtoSku; ?>" maxlength="32">
        ...
        <div class="listagem-grid">
            ...
            <div class="grid-items">
                <button type="button" onclick="window.location.href = 'produto.php';" name="btnretornar">Desistir</button>
